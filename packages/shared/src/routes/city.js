...
const { createCity, updateCity } = require('../validations/city');
 ...
 */
router.get('/all', cityController.getAllCities.bind(cityController));
 ...
 */
router.post('/', validate(createCity), checkPermissions(['create']), cityController.createCity.bind(cityController));
 ...
 */
router.put('/:id', validate(updateCity), checkPermissions(['update']), cityController.updateCity.bind(cityController));
 ...
 */
router.delete('/:id', checkPermissions(['delete']), cityController.deleteCity.bind(cityController));
 ...
 *         description: Categoria não encontrada
 */
router.patch('/activate/:id', checkPermissions(['update']), cityController.activateCity.bind(cityController));
 ...
 *         description: Categoria não encontrada
 */
router.patch('/deactivate/:id', checkPermissions(['update']), cityController.deactivateCity.bind(cityController));
