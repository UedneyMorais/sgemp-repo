...
const { createCustomer, updateCustomer } = require('../validations/customer');
 ...
 * /customer:
 *   get:
 *     summary: Retorna todas os clientes com paginação
 *     tags: [Clientes]
 *     parameters:
 *       - in: query
 *         name: page
 ...
 * /customer/all:
 *   get:
 *     summary: Retorna todas os clientes sem paginação
 *     tags: [Clientes]
 *     responses:
 *       200:
 *         description: Lista de todas os clientes ordenados por nome.
 *         content:
 *           application/json:
 *             schema:
 *               type: array
 ...
 */
router.post('/', validate(createCustomer), checkPermissions(['create']), customerController.createCustomer.bind(customerController));
 ...
 */
router.put('/:id', validate(updateCustomer), checkPermissions(['update']), customerController.updateCustomer.bind(customerController));
 ...
 */
router.delete('/:id', checkPermissions(['delete']), customerController.deleteCustomer.bind(customerController));
 ...
 *         description: Categoria não encontrada
 */
router.patch('/activate/:id', checkPermissions(['update']), customerController.activateCustomer.bind(customerController));
 ...
 *         description: Categoria não encontrada
 */
router.patch('/deactivate/:id', checkPermissions(['update']), customerController.deactivateCustomer.bind(customerController));
